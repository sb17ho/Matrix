...
public class Methods {
    ...
    public static void cofactor(int row, int col, double[][] temp, double[][] array) {
        int r1 = 0, c1 = 0;
    ...
    public static double[][] multiplyByConstant(double[][] arr1, double constant) {
        double[][] result = new double[arr1.length][arr1.length];
    ...
    public static double[][] transpose(double[][] arr1) {
        double[][] result = new double[arr1.length][arr1.length];
    ...
    public static double trace(double[][] arr1) {
        double sum = 0;
